...
Also there's plans to make a website for this program as a way for user to interact with the so-called "application"

<b>!RN it's only possible to convert one of three logos to ASCII!</b>
